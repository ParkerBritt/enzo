...
Rectangle {
    ...
    // Whether the field carries a picker listing the attributes on the node's input.
    readonly property bool picksAttribute: item ? item.style === "attribute" : false
    ...
    TextInput {
        ...
        anchors.rightMargin: parameter.picksAttribute ? 24 : 8
    ...
    // Opens the list of attribute names.
    MouseArea {
        id: picker

        visible: parameter.picksAttribute
        width: 24
