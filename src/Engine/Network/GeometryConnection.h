...
class GeometryConnection
{
  public:
    ...
    {
        return (
            getInputOpId() == other.getInputOpId() && getOutputOpId() == other.getOutputOpId() &&
            getInputIndex() == other.getInputIndex() && getOutputIndex() == other.getOutputIndex()
        );
    }
    ...
    {
        return os << p.inputOperatorId_ << ":" << p.inputIndex_ << " -> " << p.outputOperatorId_
                  << ":" << p.outputIndex_ << "\n";
    }
