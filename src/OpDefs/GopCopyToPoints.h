...
class GopCopyToPoints : public enzo::nt::NodeDef
{
  public:
    GopCopyToPoints(enzo::nt::NetworkManager* network, enzo::nt::NodeType nodeType);
    ...
    {
        return new GopCopyToPoints(network, nodeType);
    }
